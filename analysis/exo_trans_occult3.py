...
from numpy import size, zeros, where, arccos, sqrt, pi, log, savetxt, linspace, concatenate, c_
...
if __name__ == "__main__":
    ...
    z=sqrt(t**2+(2*0.084)**2)
    x,y = occultquad(z, 0.35, 0.225, 0.084) # hui02

    x=concatenate((x[1:][::-1],x))
    z=concatenate((-z[1:][::-1],z))
    t=concatenate((-t[1:][::-1],t))
    savetxt('/Users/silver/Dropbox/sci/project_exo/models/hui02_no_ref.dat', c_[t,x])
